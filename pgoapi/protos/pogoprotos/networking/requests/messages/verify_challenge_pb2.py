...
# source: pogoprotos/networking/requests/messages/verify_challenge.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pogoprotos/networking/requests/messages/verify_challenge.proto',
  package='pogoprotos.networking.requests.messages',
  syntax='proto3',
  serialized_pb=_b('\n>pogoprotos/networking/requests/messages/verify_challenge.proto\x12\'pogoprotos.networking.requests.messages\"\'\n\x16VerifyChallengeMessage\x12\r\n\x05token\x18\x01 \x01(\tb\x06proto3')
)
...
VerifyChallengeMessage = _reflection.GeneratedProtocolMessageType('VerifyChallengeMessage', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.requests.messages.verify_challenge_pb2'
