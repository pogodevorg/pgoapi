...
# source: pogoprotos/networking/requests/messages/check_codename_available_message.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pogoprotos/networking/requests/messages/check_codename_available_message.proto',
  package='pogoprotos.networking.requests.messages',
  syntax='proto3',
  serialized_pb=_b('\nNpogoprotos/networking/requests/messages/check_codename_available_message.proto\x12\'pogoprotos.networking.requests.messages\"1\n\x1d\x43heckCodenameAvailableMessage\x12\x10\n\x08\x63odename\x18\x01 \x01(\tb\x06proto3')
)
...
CheckCodenameAvailableMessage = _reflection.GeneratedProtocolMessageType('CheckCodenameAvailableMessage', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.requests.messages.check_codename_available_message_pb2'
